...
import { Component } from "./tbDataGrid.component"
import type {
  ComponentProps,
  ButtonClickedEvent,
  LinkClickedEvent,
  ComponentEvents,
} from "./tbDataGrid.component"
export { DataGridElType } from "./tbDataGrid.component"
export type { DataGridEl } from "./tbDataGrid.component"

const CARD_TYPE = "tb/datagrid"

export const TbDataGrid = createCardDeclaration<
  ComponentProps,
  ComponentEvents
>(CARD_TYPE)
...
export const onLinkClicked = createOnAction<LinkClickedEvent>(
